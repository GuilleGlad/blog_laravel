        ...
        @method('PUT')
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input ml-2" type="radio" name='status' id="status" value="0" {{ $category->status == 0 ? 'checked' : '' }}>
                </div>

                <div class="form-check form-check-inline">
                    <label class="form-check-label" for="">Público</label>
                    <input class="form-check-input ml-2" type="radio" name='status' id="status" value="1" {{ $category->status == 1 ? 'checked' : '' }}>
                </div>
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input ml-2" type="radio" name='is_featured' id="is_featured" value="0" {{ $category->is_featured == 0 ? 'checked' : '' }}>
                </div>

                <div class="form-check form-check-inline">
                    <label class="form-check-label">Si</label>
                    <input class="form-check-input ml-2" type="radio" name='is_featured' id="is_featured" value="1" {{ $category->is_featured == 1 ? 'checked' : '' }}>
                </div>
